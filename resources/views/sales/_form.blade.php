...
<div class="card-body row">
    ...
    <div class="form-group col-md-4">
        ...
        <input type="number" step="0.01" min="0" name="paid_amount" id="paid_amount" class="form-control"
            value="{{ old('paid_amount', (float) ($sale?->paid_amount ?? 0)) }}" required>
    </div>
    <div class="form-group col-md-4">
    ...
    <script>
        ...
        function productOptions(selected) {
            ...
            products.forEach((product) => {
                ...
                opts +=
                    `<option value="${product.id}" data-price="${product.price}" data-stock="${product.stock}" ${isSelected}>${product.name} (stok: ${product.stock})</option>`;
            });
